...
<body>
    ...
    <script type="text/babel" data-type="module">
        ...
        try {
            ...
            // --- Cross-Origin Scroll Tracker for Immersive Mode Close Button ---
            let scrollTimer = null;
            const checkBoundary = () => {
                const atTop = window.scrollY <= 10;
                // document.documentElement.scrollHeight is the total height
                ...
                // Only broadcast to parent if we've reached an extremity
                if (atTop || atBottom) {
                    window.parent.postMessage({ type: 'PREVIEW_SCROLL', isBoundary: true }, '*');
                } else {
                    window.parent.postMessage({ type: 'PREVIEW_SCROLL', isBoundary: false }, '*');
                }
            };
            ...
            window.addEventListener('scroll', () => {
                ...
                // Debounce to keep 60fps scrolling
                scrollTimer = setTimeout(checkBoundary, 50);
            });
        } catch (e) {
        ...
        if (sub.file_type === 'text/html' && sub.content_text) {
            ...
            return `<div class="code-preview-container" id="previewContainer">
                        <div class="preview-header">
                            ...
                            <button class="preview-close-btn hidden-close-btn" id="previewCloseBtn" title="Close Immersive View">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <div style="display: flex; gap: 8px;">
                            <a href="${this.createWhatsAppShareUrl(sub.title, sub.id)}" target="_blank" rel="noopener noreferrer" class="btn clay-btn btn-sm btn-snake btn-round btn-icon" style="background:#25D366; border-color:#25D366; color:white; padding: 0 10px;" title="Share on WhatsApp">
                                <span></span><span></span><span></span><span></span>
    ...
    createWhatsAppShareUrl(title, workId) {
        // Build the public absolute URL (works even locally via window.location)
        // Inject ?fullscreen=true into the query string before the hash router handles it
            ...
            <div class="profile-container animate-fade-in">
                <div class="glass-card profile-card">
                    <div class="profile-header">
                        <div class="profile-avatar-large" id="profile-avatar-display" style="position: relative; cursor: pointer;" title="Change Profile Picture">
                            ${user.avatar_url
                ? `<img src="${user.avatar_url}" alt="Profile Picture" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">`
                    ...
                    <div class="detail-card glass-card">
                        ...
                        <div class="detail-actions">
                            ...
                            <div class="main-actions">
                                <a href="${UI.createWhatsAppShareUrl(sub.title, sub.id)}" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-snake" style="border-color:#25D366; color:#25D366; display:flex; align-items:center; gap:8px;">
                                    <span></span><span></span><span></span><span></span>
        ...
        studentDashboard: (profile) => `
            <div class="student-dashboard animate-fade-in">
                ...
                <div class="sd-welcome glass-card animate-slide-up stagger-1">
                    ...
                    <div class="sd-welcome-avatar" style="overflow: hidden; padding: 0;">
                        ${profile?.avatar_url
                ? `<img src="${profile.avatar_url}" alt="Profile" style="width: 100%; height: 100%; object-fit: cover;">`
                : `<span>${(profile?.display_name || 'C').charAt(0).toUpperCase()}</span>`
            }
                    </div>
                </div>
                ...
                <div class="sd-profile-shortcut glass-card">
                    <div class="sd-ps-header">
                        <div class="sd-ps-avatar" style="overflow: hidden; padding: 0;">
                            ${profile?.avatar_url
                ? `<img src="${profile.avatar_url}" alt="Profile" style="width: 100%; height: 100%; object-fit: cover;">`
                : `<span>${(profile?.display_name || 'C').charAt(0).toUpperCase()}</span>`
            }
