...
import { DigitalClassroomPage } from '../../pages/digital-classroom.js?v=student-exam-redesign-v4';
...
const App = {
    ...
    async route() {
        ...
        if (!this.user && !hasRole && page !== 'login' && page !== 'onboarding' && page !== 'explore' && page !== 'home' && page !== 'remote' && !isClassroomRoute && !isPublicClassroomRoute) {
        ...
        try {
            switch (page) {
                ...
                case 'classroom': {
                    ...
                    const studentClassroomPage = ['student', 'student-exams', 'student-exam', 'join', 'my-classes'].includes(classroomPage);
